...
public class MathHelper {
   ...
   public static float sin(float p_76126_0_) {
	  return fastMath ? MeowMath.sin(p_76126_0_) : SIN_TABLE_FAST[(int) (p_76126_0_ * radToIndex) & 4095];
   }

   public static float sin(double d) {
	  return fastMath ? MeowMath.sin(d) : SIN_TABLE_FAST[(int) (d * radToIndex) & 4095];
   }
   ...
   public static float cos(float value) {
	  return fastMath ? MeowMath.cos(value) : SIN_TABLE_FAST[(int) (value * radToIndex + 1024.0F) & 4095];
   }
