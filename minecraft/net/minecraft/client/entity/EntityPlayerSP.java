...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   /**
    * Used to tell if the player pressed forward twice. If this is at 0 and it's pressed (And they are allowed to sprint, aka enough food on the ground etc) it sets this to 7. If
    * it's pressed and it's greater than 0 enable sprinting.
    */
   ...
   public void onUpdateWalkingPlayer() {
	  ...
	  if (mc.gameSettings.keyBindAttack.isKeyDown() && mc.thePlayer.isUsingItem() && Settings.getBool(MLibSettings.REVERT_OLD_ANIMATIONS)) {
		 if (mc.objectMouseOver != null
			   && mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
			if (mc.thePlayer != null) {
			   mc.thePlayer.clientSideSwing();
			}
		 }
	  }
    ...
    */
   public void sendChatMessage(String message) { this.sendQueue.addToSendQueue(new C01PacketChatMessage(message)); }
