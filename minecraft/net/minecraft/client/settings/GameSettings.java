...
public class GameSettings {
   ...
   public GameSettings(Minecraft mcIn, File optionsFileIn)
   {
	  this.keyBindings = (KeyBinding[]) ((KeyBinding[]) ArrayUtils.addAll(new KeyBinding[] { this.keyBindAttack,
			...
			this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines }, this.keyBindsHotbar));
   ...
   /**
    * Returns the translation of the given index in the given String array. If the index is smaller than 0 or greater than/equal to the length of the String array, it is changed
    * to 0.
    * 
												...
												: (settingOption == GameSettings.Options.SATURATION
													  ...
													  : (settingOption == GameSettings.Options.CHAT_OPACITY
															...
															: (settingOption == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED
																  ...
																  : (settingOption == GameSettings.Options.CHAT_HEIGHT_FOCUSED
																		? s1 + GuiNewChat.calculateChatboxHeight(f)
																			  + "px"
																		: (settingOption == GameSettings.Options.CHAT_WIDTH
																			  ? s1 + GuiNewChat.calculateChatboxWidth(f)
																					+ "px"
																			  : (settingOption == GameSettings.Options.RENDER_DISTANCE
																					? s1 + (int) f1 + " chunks"
																					: (settingOption == GameSettings.Options.MIPMAP_LEVELS
   ...
   public float getSoundLevel(SoundCategory sndCategory) {
	  return this.mapSoundLevels.containsKey(sndCategory) ? ((Float) this.mapSoundLevels.get(sndCategory)).floatValue()
			: 1.0F;
   }
   ...
   private void setOptionValueOF(GameSettings.Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_) {
	  ...
	  if (p_setOptionValueOF_1_ == GameSettings.Options.SCREENSHOT_SIZE) {
		 ...
		 if (!OpenGlHelper.isFramebufferEnabled()) {
			ChatComponentText ichatcomponent = new ChatComponentText("Enable framebuffer");
			...
			MinecraftInstance.mc.ingameGUI.getChatGUI()
				  .printChatMessage(new ChatComponentTranslation("ERROR: ", ichatcomponent));
   ...
   public static enum Options
   {
	  ...
	  STREAM_VOLUME_SYSTEM("options.stream.systemVolume", true, false), STREAM_KBPS("options.stream.kbps", true, false),
	  STREAM_FPS("options.stream.fps", true, false), STREAM_COMPRESSION("options.stream.compression", false, false),
	  ...
	  REALMS_NOTIFICATIONS("options.realmsNotifications", false, true), FOG_FANCY("of.options.FOG_FANCY", false, false),
	  ...
	  ANIMATED_LAVA("of.options.ANIMATED_LAVA", false, false), ANIMATED_FIRE("of.options.ANIMATED_FIRE", false, false),
	  ...
	  AUTOSAVE_TICKS("of.options.AUTOSAVE_TICKS", false, false), BETTER_GRASS("of.options.BETTER_GRASS", false, false),
	  ...
	  SCREENSHOT_SIZE("of.options.SCREENSHOT_SIZE", false, false), CUSTOM_GUIS("of.options.CUSTOM_GUIS", false, false),
	  ...
	  public void setValueMax(float value) { this.valueMax = value; }

	  public float normalizeValue(float value) {
		 return MathHelper.clamp_float((this.snapToStepClamp(value) - this.valueMin) / (this.valueMax - this.valueMin),
			   0.0F, 1.0F);
	  }
