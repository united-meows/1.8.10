...
public class ModelDragon extends ModelBase
{
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            f3 = (float)((double)f3 - MathHelper.cos((float)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0D);
            f4 = (float)((double)f4 - MathHelper.sin((float)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0D);
        ...
        for (int k = 0; k < 12; ++k)
        {
            ...
            f3 = (float)((double)f3 - MathHelper.cos((float)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0D);
            f4 = (float)((double)f4 - MathHelper.sin((double)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0D);
            this.spine.render(scale);
        }
